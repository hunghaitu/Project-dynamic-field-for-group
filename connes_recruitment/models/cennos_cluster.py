...
class CennosCluster(models.Model):
    _name = "cennos.cluster"
    _description = "Cennos Cluster"
    _order = "name"
    ...
    group_ids = fields.One2many("cennos.group", "cluster_id", string="Groups")
